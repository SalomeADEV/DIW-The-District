...
<div class="row">
            ...
            <div class="col-md-4">
              ...
              <a href=""> <img src="assets/img/category/burger_cat.jpg" class="img-fluid rounded-start" alt="burger"></a>
                <div class="card-body">
  ...
  <div class="col-md-4">
    <div class="card mb-3 mx-5 col-md-6" style="max-width: 540px;">
      <a href=" "> <img src="assets/img/food/hamburger.jpg" class="img-fluid rounded-start"  alt="hamburger"></a>
      <div class="card-body">
...
<div class="col-md-4">
  <div class="card mb-3 mx-5 col-md-6" style="max-width: 540px;">
     <a href=""> <img src="assets/img/food/Food-Name-6340.jpg" class="img-fluid rounded-start"  alt="Burger"></a>
    <div class="card-body">
      <h5 class="card-title"><Burger></h5>
      <p class="card-text">
